...
Pod::Spec.new do |s|
  s.name             = 'Tappabel'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Tappabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Tappabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ahmed Abdul Badie' => 'badie.ahmed@icloud.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Tappabel.git', :tag => s.version.to_s }
